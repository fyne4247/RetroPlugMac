...
int SWELL_IsRetinaHWND(HWND hwnd)
{
  ...
  if (w)
  {
    ...
    // objc_msgSend_stret is unavailable on arm64; the unified objc_msgSend ABI
    // is used for struct returns on Apple Silicon.
#if defined(__aarch64__) || defined(__arm64__)
    NSRect (*tmp)(id receiver, SEL operation, NSRect) = (NSRect (*)(id, SEL, NSRect))objc_msgSend;
#else
